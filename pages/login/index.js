                    ...
                    <form className="pt-4" onSubmit={this.signInHandler}>
                        ...
                        {this.state.userData ? <div className=" py-4 mx-auto d-flex text-light align-items-center justify-content-center">
                            ...
                            <div className="text-light px-3 ">
                                ...
                                <h4 className="text-dark h6">{this.state.userData.username} is already logged in</h4>
                                <Link href={"/admin"} ><a className="btn btn-outline-dark px-3 btn-sm  rounded-pill"> Continue as {this.state.userData.username}
                                </a>
                                </Link>
                            </div>
                        </div>
                        ...
                        <button
                            className='googleBtn btn btn-lg btn-block  mb-2'
                            type="button"
